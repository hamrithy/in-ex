...
<div class="box box-primary">
    <div class="box-body">
        {{Form::open(['url'=>'/dashboard/statements/add','method'=>'post','id'=>'frmStatement'])}}
        <div class='col-md-3'>
...
<script type="text/javascript">
    ...
    function getFilter(){
        ...
        var to=$("#to").val();
        $.ajax({
            url : '/dashboard/statements/getStatement/'+from+'/'+to,
            method:'GET',
            dataType:'html',
    ...
    function printPage () {
        ...
        $.ajax({
            url : '/dashboard/statements/add',
            method:'POST',
            dataType:'json',
            data:data,
            success:function(response){
                $("#flashMessage").find('#className').addClass(response.className);
                $("#flashMessage").find('#message').html(response.message);
