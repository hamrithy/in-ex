...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Update Revenue Type</h3>
    </div>
    {{Form::model($revenue_type,['url'=>'/dashboard/revenue-types/edit/'.$revenue_type->id,'method'=>'post'])}}
        <div class="box-body">
            <div class="form-group @if ($errors->has('type')) has-error @endif">
                {{Form::label('type','Revenue Type')}}
